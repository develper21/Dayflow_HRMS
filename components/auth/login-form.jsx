    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      {error && (
        <div className="p-4 bg-red-600 border border-black shadow-[4px_4px_0_0_#000] flex items-center gap-3">
          <div className="w-6 h-6 bg-white flex items-center justify-center font-black text-red-600 text-xs">
            !
          </div>
          <p className="text-white text-[10px] font-black uppercase tracking-widest font-mono">
            AUTH_ERROR: {error}
          </p>
        </div>
      )}
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          />
          {errors.email && (
            <p className="text-[8px] font-black text-red-600 uppercase font-mono">
