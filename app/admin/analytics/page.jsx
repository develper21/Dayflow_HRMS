                    ...
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center">
                            ...
                            <div className="ml-10 flex items-center space-x-4">
                                ...
                                <Link href="/admin/analytics" className="text-blue-600 hover:text-blue-800 px-3 py-2 rounded-md text-sm font-medium">
                                    Analytics
                                </Link>
                                <Link href="/admin/reports" className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                                    Reports
                                </Link>
                                <Link href="/admin/performance" className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                                    Performance
                                </Link>
